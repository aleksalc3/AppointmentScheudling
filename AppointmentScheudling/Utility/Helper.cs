...
namespace AppointmentScheudling.Utility
{
    public class Helper
    {
        ...
        public static string appointmentExist = "Appointment for selected date and time already exist";
        ...
        public static string meetingConfirmError = "Meeting confirm FAILURE";
